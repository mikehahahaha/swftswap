...
export declare function openContext(ctx: CompilerContext, sources: {
    code: string;
    path: string;
    origin: TypeOrigin;
}[], funcSources: {
...
export declare function openMockContext(ctx: CompilerContext, types: ASTType[], functions: (ASTNativeFunction | ASTFunction)[], constants: ASTConstant[]): CompilerContext;
export {};
