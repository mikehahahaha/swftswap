PROGRAM{
  ...
  DECLPROC $MathTester$_fun_precendence1
  DECLPROC $MathTester$_fun_precendence2
  DECLPROC $MathTester$_fun_precendence3
  DECLPROC $MathTester$_fun_precendence4
  DECLPROC $MathTester$_fun_precendence5
  DECLPROC $MathTester$_fun_precendence6
  DECLPROC $MathTester$_fun_precendence7
  DECLPROC $MathTester$_fun_precendence8
  DECLPROC $MathTester$_fun_precendence9
  DECLPROC $MathTester$_fun_precendence10
  DECLPROC $MathTester$_fun_precendence11
  DECLPROC $MathTester$_fun_precendence12
  ...
  69423 DECLMETHOD %precendence1
  81740 DECLMETHOD %precendence2
  77677 DECLMETHOD %precendence3
  89994 DECLMETHOD %precendence4
  85931 DECLMETHOD %precendence5
  98248 DECLMETHOD %precendence6
  94185 DECLMETHOD %precendence7
  105990 DECLMETHOD %precendence8
  101927 DECLMETHOD %precendence9
  125116 DECLMETHOD %precendence10
  129181 DECLMETHOD %precendence11
  116990 DECLMETHOD %precendence12
  ...
  $MathTester$_fun_precendence1 PROCREF:<{
    12 PUSHINT
  }>
  $MathTester$_fun_precendence2 PROCREF:<{
    4 PUSHINT
  }>
  $MathTester$_fun_precendence3 PROCREF:<{
    12 PUSHINT
  }>
  $MathTester$_fun_precendence4 PROCREF:<{
    12 PUSHINT
  }>
  $MathTester$_fun_precendence5 PROCREF:<{
    5 PUSHINT
  }>
  $MathTester$_fun_precendence6 PROCREF:<{
    0 PUSHINT
  }>
  $MathTester$_fun_precendence7 PROCREF:<{
    7 PUSHINT
  }>
  $MathTester$_fun_precendence8 PROCREF:<{
    3 PUSHINT
  }>
  $MathTester$_fun_precendence9 PROCREF:<{
    7 PUSHINT
  }>
  $MathTester$_fun_precendence10 PROCREF:<{
    3 PUSHINT
  }>
  $MathTester$_fun_precendence11 PROCREF:<{
    3 PUSHINT
  }>
  $MathTester$_fun_precendence12 PROCREF:<{
    5 PUSHINT
  }>
  ...
  %precendence1 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence1 INLINECALLDICT
    NIP
  }>
  %precendence2 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence2 INLINECALLDICT
    NIP
  }>
  %precendence3 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence3 INLINECALLDICT
    NIP
  }>
  %precendence4 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence4 INLINECALLDICT
    NIP
  }>
  %precendence5 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence5 INLINECALLDICT
    NIP
  }>
  %precendence6 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence6 INLINECALLDICT
    NIP
  }>
  %precendence7 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence7 INLINECALLDICT
    NIP
  }>
  %precendence8 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence8 INLINECALLDICT
    NIP
  }>
  %precendence9 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence9 INLINECALLDICT
    NIP
  }>
  %precendence10 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence10 INLINECALLDICT
    NIP
  }>
  %precendence11 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence11 INLINECALLDICT
    NIP
  }>
  %precendence12 PROC:<{
    $MathTester$_contract_load INLINECALLDICT
    $MathTester$_fun_precendence12 INLINECALLDICT
    NIP
  }>
  ...
  get_abi_ipfs PROC:<{
    x{697066733a2f2f516d66443466694c72775972486f6e736a63434447567544346b464b3274426a57777951764c4831583367454b41} PUSHSLICE
  }>
