PROGRAM{
  ...
  DECLPROC ?fun_ref_0f13ff147f9453dd;
  DECLPROC ?fun_ref_10c319ce0484d846;
  DECLPROC ?fun_ref_79a312552536cae9;
  DECLPROC ?fun_ref_7ca9042b0b911c4c;
  DECLPROC ?fun_ref_8e370b5dfb283d6d;
  DECLPROC ?fun_ref_acdaf5f6b40d7143;
  ...
  recv_internal PROC:<{
    ...
    2 8 BLKSWAP
    ?fun_ref_acdaf5f6b40d7143 INLINECALLDICT
    130 THROWIFNOT
    NEWC
    3 GETGLOBVAR
    s0 s1 XCHG
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D654C5256326E4563697963684463653548624D4857386A556B7672763365426E6E3761687856554D7575677482_} PUSHSLICE
  }>
  ...
  ?fun_ref_0f13ff147f9453dd PROCREF:<{
    257 PUSHINT
    17 PUSHINT
    NULL
    s0 PUSH
  ...
  ?fun_ref_79a312552536cae9 PROCREF:<{
    257 PUSHINT
    17 PUSHINT
  ...
  ?fun_ref_acdaf5f6b40d7143 PROCREF:<{
    2 SAVE
    SAMEALTSAVE
    s0 s1 XCHG
    <{
    ...
    <{
      ...
      <{
        s0 POP
        ?fun_ref_79a312552536cae9 INLINECALLDICT
        -1 PUSHINT
        RETFALSE
      }> PUSHCONT
      IFJMP
      ...
      <{
        s0 POP
        ?fun_ref_0f13ff147f9453dd INLINECALLDICT
        -1 PUSHINT
        RETFALSE
      }> PUSHCONT
      IFJMP
