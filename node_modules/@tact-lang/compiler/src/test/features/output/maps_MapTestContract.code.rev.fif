PROGRAM{
  ...
  DECLPROC ?fun_ref_5b24e915b9049eb5;
  ...
  recv_internal PROC:<{
    ...
    s13 s15 XCHG
    2 13 BLKSWAP
    ?fun_ref_5b24e915b9049eb5 INLINECALLDICT
    130 THROWIFNOT
    NEWC
    3 GETGLOBVAR
    s0 s1 XCHG
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D516F6A336E59464438313335646E54416538447064634E483862416B7432417148675638757758744454367782_} PUSHSLICE
  }>
  ?fun_121499 PROC:<{
    ?fun_ref_ad961e5c0697dcd8 INLINECALLDICT
  ...
  ?fun_ref_5b24e915b9049eb5 PROCREF:<{
    2 SAVE
    SAMEALTSAVE
    s0 s1 XCHG
    <{
