...
semantics.addOperation("resolve_program_item", {
    ...
    Contract_withTraits(arg0, _arg1, arg2, _arg3, arg4, _arg5, _arg6, arg7, _arg8) {
        (0, checkVariableName_1.checkVariableName)(arg2.sourceString, (0, ast_1.createRef)(arg2));
        return (0, ast_1.createNode)({
            kind: "def_contract",
            origin: ctx.origin,
    ...
    Trait_withTraits(arg0, _arg1, arg2, _arg3, arg4, _arg5, _arg6, arg7, _arg8) {
        (0, checkVariableName_1.checkVariableName)(arg2.sourceString, (0, ast_1.createRef)(arg2));
        return (0, ast_1.createNode)({
            kind: "def_trait",
            origin: ctx.origin,
...
semantics.addOperation("resolve_declaration", {
    ...
    Function_withType(arg0, _arg1, arg2, _arg3, arg4, arg5, _arg6, _arg7, arg8, _arg9, arg10, _arg11) {
        if (arg4.source.contents === "" && arg5.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(arg5));
        }
    ...
    NativeFunction_withType(_arg0, _arg1, arg2, _arg3, arg4, arg5, arg6, _arg7, arg8, arg9, _arg10, _arg11, arg12, _arg13) {
        if (arg8.source.contents === "" && arg9.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(arg9));
        }
    ...
    ContractInit(_arg0, _arg1, arg2, arg3, _arg4, _arg5, arg6, _arg7) {
        if (arg2.source.contents === "" && arg3.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(arg3));
        }
        return (0, ast_1.createNode)({
...
semantics.addOperation("resolve_statement", {
    ...
    StatementForEach(_arg0, _arg1, arg2, _arg3, arg4, _arg5, arg6, _arg7, _arg8, arg9, _arg10) {
        (0, checkVariableName_1.checkVariableName)(arg2.sourceString, (0, ast_1.createRef)(arg2));
        (0, checkVariableName_1.checkVariableName)(arg4.sourceString, (0, ast_1.createRef)(arg4));
        return (0, ast_1.createNode)({
...
semantics.addOperation("resolve_expression", {
    ...
    ExpressionInitOf(_arg0, arg1, _arg2, arg3, arg4, _arg5) {
        if (arg3.source.contents === "" && arg4.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(arg4));
        }
        return (0, ast_1.createNode)({
            kind: "init_of",
            name: arg1.sourceString,
