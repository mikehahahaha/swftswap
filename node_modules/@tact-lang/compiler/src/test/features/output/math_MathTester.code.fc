...
(tuple, int) $MathTester$_fun_precendence1(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, ((5 & 6) | ((1 << (5 + ((11 * 3) % 12))) >> 11)));
}

(tuple, int) $MathTester$_fun_precendence2(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, ((5 & 6) | ((1 << (((5 + 11) * 3) % 12)) >> 11)));
}

(tuple, int) $MathTester$_fun_precendence3(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, ((5 & 6) | ((1 << (5 + (11 * (3 % 12)))) >> 35)));
}

(tuple, int) $MathTester$_fun_precendence4(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, ((5 & 6) | ((1 << (5 + ((11 * 3) % 12))) >> 11)));
}

(tuple, int) $MathTester$_fun_precendence5(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, (5 | (6 & 8)));
}

(tuple, int) $MathTester$_fun_precendence6(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, ((5 | 6) & 8));
}

(tuple, int) $MathTester$_fun_precendence7(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, ((5 ^ 6) | 7));
}

(tuple, int) $MathTester$_fun_precendence8(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, (5 ^ (6 & 7)));
}

(tuple, int) $MathTester$_fun_precendence9(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, ((5 ^ 6) | 7));
}

(tuple, int) $MathTester$_fun_precendence10(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, ((5 ^ 6) | (7 & 8)));
}

(tuple, int) $MathTester$_fun_precendence11(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, ((5 ^ 6) | (7 & 8)));
}

(tuple, int) $MathTester$_fun_precendence12(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, (5 ^ ((6 | 7) & 8)));
}
...
_ %precendence1() method_id(69423) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence1();
    return res;
}

_ %precendence2() method_id(81740) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence2();
    return res;
}

_ %precendence3() method_id(77677) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence3();
    return res;
}

_ %precendence4() method_id(89994) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence4();
    return res;
}

_ %precendence5() method_id(85931) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence5();
    return res;
}

_ %precendence6() method_id(98248) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence6();
    return res;
}

_ %precendence7() method_id(94185) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence7();
    return res;
}

_ %precendence8() method_id(105990) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence8();
    return res;
}

_ %precendence9() method_id(101927) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence9();
    return res;
}

_ %precendence10() method_id(125116) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence10();
    return res;
}

_ %precendence11() method_id(129181) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence11();
    return res;
}

_ %precendence12() method_id(116990) {
    var self = $MathTester$_contract_load();
    var res = self~$MathTester$_fun_precendence12();
    return res;
}
...
_ get_abi_ipfs() method_id {
    return "ipfs://QmfD4fiLrwYrHonsjcCDGVuD4kFK2tBjWwyQvLH1X3gEKA";
}
